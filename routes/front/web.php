...
Route::group(['namespace' => 'Front'], function () {
    ...
    // Liên hệ
    Route::get('/he-thong.html','FrontController@storePage')->name('front.store-page');
    Route::get('/he-thong/get-location','FrontController@getLocation')->name('front.get-location');
